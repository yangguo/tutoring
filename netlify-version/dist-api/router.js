...
router.get('/auth/children', authenticateToken, requireRole(['parent']), async (req, res) => {
    try {
        const { userId } = req.user;
...
router.get('/books/discussions', authenticateToken, async (req, res) => {
    try {
        const { userId } = req.user;
...
router.post('/books/reading-session', authenticateToken, async (req, res) => {
    try {
...
router.get('/books/progress', authenticateToken, async (req, res) => {
    try {
        const { userId } = req.user;
...
router.get('/books/reading-sessions', authenticateToken, async (req, res) => {
    try {
        const { userId } = req.user;
...
router.get('/books/speaking-sessions', authenticateToken, async (req, res) => {
    try {
        const { userId } = req.user;
        const { book_id, page = 1, limit = 10 } = req.query;
        const offset = (Number(page) - 1) * Number(limit);
...
router.post('/books/vocabulary/learn', authenticateToken, async (req, res) => {
    try {
        const { userId } = req.user;
...
router.get('/books/vocabulary/learned', authenticateToken, async (req, res) => {
    try {
        const { userId } = req.user;
...
router.post('/books/evaluate-pronunciation', authenticateToken, async (req, res) => {
    try {
...
router.post('/books/analyze-image', authenticateToken, async (req, res) => {
    try {
...
router.post('/books/:bookId/analyze-images', authenticateToken, requireRole(['admin']), async (req, res) => {
    try {
        const { bookId } = req.params;
...
router.post('/books/extract-vocabulary', authenticateToken, async (req, res) => {
    try {
...
router.post('/books/discuss', authenticateToken, async (req, res) => {
    try {
...
// Regenerate Routes
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
router.post('/books/:bookId/pages/:pageId/regenerate-description', authenticateToken, async (req, res) => {
    try {
...
router.post('/upload/book', authenticateToken, requireRole(['parent', 'admin']), upload.single('file'), handleMulterError, async (req, res) => {
    try {
...
router.patch('/upload/book/:bookId', authenticateToken, requireRole(['parent', 'admin']), async (req, res) => {
    try {
        const { bookId } = req.params;
...
router.post('/upload/book/:bookId/pages', authenticateToken, requireRole(['parent', 'admin']), upload.array('pages', 50), async (req, res) => {
    try {
        const { bookId } = req.params;
...
router.get('/upload/books', authenticateToken, async (req, res) => {
    try {
        const { userId } = req.user;
...
router.delete('/upload/book/:bookId', authenticateToken, requireRole(['parent', 'admin']), async (req, res) => {
    try {
        const { bookId } = req.params;
        const { userId } = req.user;
        // Verify book exists and user has permission
